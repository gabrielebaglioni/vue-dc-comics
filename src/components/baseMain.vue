<template>
  <main class="main">
    ...
    <div class="main__bottom ">
       Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, fuga veniam! Beatae incidunt, animi at voluptate cupiditate dignissimos doloremque impedit. Totam adipisci ipsam ab laudantium sunt eaque harum, veniam tempora!
    </div>
  </main>
</template>
